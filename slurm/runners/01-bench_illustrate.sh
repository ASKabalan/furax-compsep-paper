...
# =============================================================================
sbatch $SBATCH_ARGS --job-name=GRID_valid-N-a100 $SLURM_SCRIPT ILLUSTRATE validation-model -n 64 -m GAL020
# with 20% noise
sbatch $SBATCH_ARGS_MULTI --job-name=GRID_noise_20-N-a100 $SLURM_SCRIPT ILLUSTRATE noise-model -n 64 -ns 20 -nr 0.2 -m GAL020
# with 100% noise
sbatch $SBATCH_ARGS_MULTI --job-name=GRID_noise_100-N-a100 $SLURM_SCRIPT ILLUSTRATE noise-model -n 64 -ns 100 -nr 1.0 -m GAL020
